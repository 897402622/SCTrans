...
parser.add_argument("--every_save_pth", default=50, type=int)
parser.add_argument("--every_print", default=10, type=int)
parser.add_argument("--dataset_dir", default='/home/Newdisk/wyt')
parser.add_argument("--batchSize", type=int, default=64, help="Training batch sizse")
...
class Net(nn.Module):
    def __init__(self, model_name, mode):
        ...
        # ************************************************loss*************************************************#
        self.cal_loss = nn.BCELoss(size_average='mean')
